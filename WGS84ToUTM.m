...
path = 'D:\matlab相关\数据\2024.06.13数据采集\2024.06.13dataset_csv\background_face2out_circle\';
% path = filepath;
name1 = 'raw_gnss.csv';
...
RadarTime = readtable([path name2]);
time_vector_radar = table2array(RadarTime);
